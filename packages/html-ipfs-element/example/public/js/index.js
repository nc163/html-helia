//
class HTMLIPFSConfigElement extends HTMLElement {
    constructor() {
        super();
        console.log("HTMLIPFSConfigElement constructor");
    }
    async fetchBlob(cid, mediatype) {
...
HTMLIPFSConfigElement.unixFs = null;
...
//
class HTMLIPFSElement extends HTMLElement {
